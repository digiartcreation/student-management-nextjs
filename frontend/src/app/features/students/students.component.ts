...
export class StudentsComponent implements OnInit {
  ...
  columnDefs: ColDef<Student>[] = [
    { headerName: 'Roll No', field: 'rollNo', width: 110, pinned: 'left' },
    ...
    { headerName: "Father", field: 'fatherName', minWidth: 140 },
    { headerName: "Father's Mobile", field: 'fatherMobile', width: 140 },
    { headerName: 'Mother', field: 'motherName', minWidth: 140 },
    { headerName: "Mother's Mobile", field: 'motherMobile', width: 140 },
    { headerName: 'Primary Mobile', field: 'parentMobile', width: 140 },
    { headerName: 'Blood', field: 'bloodGroup', width: 90 },
    {
      headerName: 'Joined',
      field: 'joiningDate',
      width: 130,
    ...
    { headerName: 'Address', field: 'address', minWidth: 200, tooltipField: 'address' },
    {
      headerName: 'Status',
      field: 'status',
      width: 110,
